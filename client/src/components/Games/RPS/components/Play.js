                ...
                setHouseElement(
                    <div className="pick">
                        ...
                        <div
                            ...
                            style={{
                                backgroundImage: `url(${setMyPickIcon(
                                    housePick
                                )}`,
                            }}
                        ></div>
                ...
                setPlayerElement(
                    <div className="pick">
                        ...
                        <div
                            ...
                            style={{
                                backgroundImage: `url(${setMyPickIcon(myPick)}`,
                            }}
                        ></div>
                        <div className="result__mobile pick__title">
                            You Picked {myPick}
    ...
    return (
        <div className="play-wrapper">
            ...
            {housePickElement ? (
                ...
                <div className="pick">
                    <div className="pick__title result__desktop">
                        The House Picked:
                    </div>
                    <div className="pick__item">
                        <span>{countDown}</span>
                    </div>
                    <div className="pick__title result__mobile">
                        The House Picked:
                    </div>
                </div>
            )}
