...
export const UPDATE_PUBLISH_VOUCHER = 'UPDATE_PUBLISH_VOUCHER';
export const UPDATE_ACTIVE_VOUCHER = "UPDATE_ACTIVE_VOUCHER";
...
export const CHECK_CURRENT_ADMIN = 'CHECK_CURRENT_ADMIN';
